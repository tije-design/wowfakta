  ...
  return (
    <div className="menti-bg min-h-screen flex flex-col items-center justify-center p-6">
      ...
      <div className="text-center mb-12 animate-slide-up">
        ...
        <p className="text-blue-300/70 text-base">
      ...
      <div className="w-full max-w-sm animate-slide-up" style={{ animationDelay: '0.08s', opacity: 0 }}>
        <div className="glass-card rounded-3xl p-6">
          <p className="text-center text-white/60 text-sm font-medium mb-5 tracking-wide uppercase">
            Siapa kamu?
          </p>
          ...
          <div className="grid grid-cols-2 gap-2.5">
            {MEMBERS.map((name, i) => (
              <button
                ...
                className="glass-card glass-card-hover group relative rounded-2xl px-3 py-3 flex items-center gap-3 transition-all duration-200 active:scale-95 animate-slide-up"
      ...
      {showPasswordModal && (
        ...
        >
          <div
            className="glass-card rounded-3xl p-6 w-full max-w-xs animate-pop-in"
            style={{ border: '1px solid rgba(8,70,161,0.4)' }}
          >
            {/* Admin avatar */}
            <div className="flex flex-col items-center mb-5">
              <Avatar name={ADMIN} size={56} rounded="rounded-2xl" className="mb-3" />
            ...
            >
              <input
                ...
                autoFocus
                className="w-full rounded-2xl px-4 py-3 text-white text-base focus:outline-none placeholder:text-white/20 transition-all duration-200 mb-3"
                style={{
            ...
            <button
              ...
              className="w-full py-3.5 rounded-2xl font-black text-white text-sm tracking-wide transition-all duration-200 active:scale-[0.98] mb-2"
              style={{ background: 'linear-gradient(135deg, #0846A1, #0655BA)' }}
            >
              Masuk →
            </button>
            <button
              ...
              className="w-full py-2.5 rounded-2xl text-white/30 text-sm hover:text-white/60 transition-colors"
            >
              Batal
            </button>
          </div>
